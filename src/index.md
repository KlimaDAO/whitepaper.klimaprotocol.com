...
holders&nbsp;(**LPs**), including a **Risk Premium** generated by the Bond
Market Synthetic Yield.
...
pools may receive a distribution of&nbsp;**A** tokens determined from the Risk
Premium calculation below. This is an
<span class="u-underline">additional</span> primary issuance to the Bond
Synthetic Yields already discussed.
...
The Risk Premium allocation is shared between **G**&nbsp;staking,
...
The total Risk Premium tokens&nbsp;${tex`R_\lambda`}:
...
2. <p id="4-3-2-2-liquidity" tabindex="-1">
    ...
    defined in [Section&nbsp;3.3.4](#3-3-4-share-of-risk-premium):
